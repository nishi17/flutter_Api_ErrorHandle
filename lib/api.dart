...
import 'dart:convert';
// TODO:(1 Unit 11 API) Import relevant packages
import 'dart:io';
import 'dart:async';
...
// We have set up an API that retrieves a list of currencies and their current exchange rate (mock data).
//   GET /currency: get a list of currencies
//   GET /currency/convert: get conversion from one currency amount to another
class Api {
  // TODO:(2 Unit 11 API)  andAdd any relevant variables helper functions
  ...
  // The API endpoint we want to hit . This API doesn't have a key but often, APIs do require authentication
  final String _url = 'flutter.udacity.com';

  // TODO:(3 Unit 11 API) Create getUnits()
  ...
  // TODO:(4 Unit 11 API) Create convert()
